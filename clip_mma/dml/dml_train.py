...
from .custom_miner import MultiSimilarityMinerWithCLIP
...
def dml_train(config):
    ...
    miner = MultiSimilarityMinerWithCLIP(epsilon=dml_cfg["miner_epsilon"])
    ...
    end_of_epoch_hook = hooks.end_of_epoch_hook(
        tester, dataset_dict, model_folder, test_interval=dml_cfg["test_interval"], patience=dml_cfg["patience"]
    )
